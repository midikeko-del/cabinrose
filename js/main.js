...
(function () {
  ...
  var I18N = {
    ms: {
      ...
      "hero.sub": "Corndog signature, nasi buttermilk dan western klasik dalam suasana minimalis di tepi Sungai Kemaman.",
      ...
      "amb.title": "Suasana santai, deko minimalis.",
      "amb.body": "Ruang selesa untuk keluarga, pasangan dan geng lepak. Terletak di River Front, berdepan McDonald's Kemaman.",
      "ev.title": "Majlis & event, kami uruskan.",
      "ev.body": "Jamuan, birthday party, majlis rasmi dan tempahan buffet. Ruang boleh ditempah untuk kumpulan besar.",
    ...
    en: {
      ...
      "hero.eyebrow": "River Front, Kemaman",
      "hero.title": "Cabin Rose Station",
      "hero.sub": "Signature corndogs, buttermilk rice and western classics in a calm, minimal space by the Kemaman river.",
      ...
      "amb.title": "Laid-back space, minimal design.",
      "amb.body": "A comfortable spot for families, couples and friends at River Front, opposite McDonald's Kemaman.",
      "ev.title": "Functions & events, handled.",
      "ev.body": "Banquets, birthday parties, official functions and buffet bookings. The space can be reserved for large groups.",
